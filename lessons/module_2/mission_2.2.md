...
![MQTT delivers bytes; message.decode turns them into text; json.loads creates a Python dictionary; then the program publishes a parsed event.](https://raw.githubusercontent.com/autolab-fi/mqtt-course-basic/main/images/lessons/lesson-08-json-parse-pipeline.svg)
